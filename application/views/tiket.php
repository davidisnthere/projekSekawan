...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item active" aria-current="page"><a href="complaint">Home</a></li>
  </ol>
</nav>
...
<table class="table table-striped table-bordered border-dark" id="ticket-list">
    <thead>
  <tr>
      <th> No</th> <th>ID Tiket</th> <th>Deskripsi</th> <th>Gambar</th> <th>Kategori</th><th>Dikirim oleh</th><th>Action</th>
  </tr>
    </thead>
    <tbody>
    <?php
    ...
    <tr>
        ...
        <td class="border border-dark" style="text-align: center;"><a class="btn btn-info btn-sm" href="complaint/edit/<?= $item->ticket_id ?>"><i class='bx bx-edit-alt'></i></a>
        <a class="delete btn btn-danger btn-sm" href="complaint/delete/<?= $item->ticket_id ?>"><i class="bx bx-trash"></i></a></td>
    </tr>
    <?php
            $no++;
    }
